...
//	private BufferedImage background = ImageLoader.loadBufferedImage("Hintergrund.png");
	...
	private boolean autoResizeFont = false, firstTime = true, drawBackground = true, isForegroundColorSet = false,
			drawBottomLine = false, drawJustTextBackground = true, invertColors = false;
...
//	}
	...
	public void setdrawJustTextBackground(boolean drawJustTextBackground) {
		this.drawJustTextBackground = drawJustTextBackground;
	}
...
//				    int descent = fm.getMaxDescent();
					...
					g.fillRect(x - padding, baseline - ascent - padding, stringWidth + (padding * 2),
